  ...
  Future<void> _onImageButtonPressed(
    ...
    if (context.mounted) {
      if (isVideo) {
        ...
        await _displayPickImageDialog(context, true, (double? maxWidth, double? maxHeight, int? quality, int? limit) async {
          try {
        ...
        await _displayPickImageDialog(context, false, (double? maxWidth, double? maxHeight, int? quality, int? limit) async {
          try {
